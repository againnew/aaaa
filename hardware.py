...
class GenericHardwareManager(HardwareManager):
    ...
    def create_configuration(self, node, ports):
        ...
        for x in target_raid_config['logical_disks']：
            raid_controller=x['controller']
            physical_disks=x['physical_disks']
            raid_level=x['raid_level']
            size_mb=x['size_gb']
            disk_name=x['volume_name']
        return client.create_virtual_disk(
            raid_controller=raid_controller,physical_disks=physical_disks,raid_level=raid_level,size_mb=size_mb,disk_name=disk_name,span_length=None,span_depth=None)
        '''
